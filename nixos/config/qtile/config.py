        ...
        top=bar.Bar(
            widgets = [
                ...
                widget.GenPollText(
                    ...
                    foreground = colors[4],
                    padding = 8, 
                    mouse_callbacks = {'Button1': lambda: qtile.cmd_spawn(myTerm + ' -e top -o %CPU')},
                ),
                sep,
                widget.Memory(
                    foreground = colors[8],
                    padding = 8, 
                    mouse_callbacks = {'Button1': lambda: qtile.cmd_spawn(myTerm + ' -e top -o %MEM')},
                ...
                widget.DF(
                    ...
                    foreground = colors[5],
                    padding = 8, 
                    mouse_callbacks = {'Button1': lambda: qtile.cmd_spawn(myTerm + ' -e sh -c "printf \'\\n\'; df -hT; read"')},
                    partition = '/',
                    format = '{uf}{m} free',
                    fmt = 'Disk: {}',
